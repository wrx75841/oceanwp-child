<?php
/**
 * Strona glowna Fanclubu Jadzi.
 *
 * front-page.php ma najwyzszy priorytet w hierarchii szablonow WordPressa
 * dla adresu glownego strony - dziala niezaleznie od tego, czy w
 * Ustawieniach czytania wybrano "strone statyczna" czy "najnowsze wpisy".
 *
 * Grafiki to wlasne, samodzielne SVG (bez zewnetrznych obrazkow/serwisow).
 */
get_header();
?>
